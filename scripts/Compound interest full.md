...
## scene: intro_greeting
[stickman: waving, happy]
[text: "복리의 마법", highlight]
[icon: lightbulb]

안녕하세요,
오늘은 여러분의 돈을 마법처럼 불려주는
복리에 대해 알아보겠습니다.

## scene: hook_question
[stickman: thinking, thinking]
[text: "💰 1억 vs 매일 2배 1원", highlight]

만약 지금 당장 1억 원을 받는 것과, 
1원부터 시작해서 매일 두 배씩 늘어나는 돈 중 
하나를 선택해야 한다면 어떻게 하시겠습니까?
...
[text: "이것이 바로 복리의 힘", highlight]
[shape: arrow, #FFD700]

이것이 바로 복리의 힘입니다.

## scene: simple_interest_intro
...
## scene: simple_interest_explain
[stickman: nodding, neutral]
[text: "단리 = 원금 × 이자율 × 기간", highlight]
[shape: line, #4FC3F7]

단리는 처음 넣은 원금에만 이자가 붙는 방식입니다.

## scene: simple_interest_example
...
## scene: compound_explain
[stickman: explaining, happy]
...
## scene: time_power
[stickman: excited, surprised]
[text: "30년 후에는?", highlight]
[icon: chart-up]

하지만 이 차이는 시간이 지날수록 눈덩이처럼 불어납니다.

## scene: time_example_simple
[stickman: headShake, sad]
[text: "단리 30년: 250만원", highlight]
[counter: 1000000 -> 2500000, currency_krw]

단리로 30년을 투자하면 250만 원에 그칩니다.

## scene: time_example_compound
[stickman: clapping, happy]
...
여기서 유용한 공식을 하나 알려드리겠습니다.

## scene: rule72_explain
[stickman: pointing, happy]
...
[stickman: explaining, neutral]
[text: "실전 예시 💼", highlight]
[icon: piggy-bank]

자, 그럼 실제로 우리 생활에 적용해 볼까요?

## scene: real_example_20s
[stickman: thumbsUp, happy]
